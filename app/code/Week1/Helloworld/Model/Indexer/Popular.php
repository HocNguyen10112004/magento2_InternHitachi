<?php
namespace Week1\Helloworld\Model\Indexer;
...
class Popular implements \Magento\Framework\Indexer\ActionInterface, \Magento\Framework\Mview\ActionInterface
{
    ...
    public function executeFull(){
        //Should take into account all placed orders in the syste
        echo "Đang chạy full reindex\n";
    }
    ...
    public function executeList(array $ids){
        ...
        echo "Đang reindex nhiều ID: " . implode(', ', $ids) . "\n";
    }
